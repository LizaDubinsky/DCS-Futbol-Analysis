...
```{r}
# read in csv so that we don't have to re-run top part in case of a premature change to players.
france_croatia_final <- read.csv("/Users/jenniflore/Desktop/dcs 375/france_croatia_final.csv")
