...
france_only_final1 <- subset(france_only_final, player.name  != "Steve Mandanda")
france_only_final2 <- subset(france_only_final1, pass.recipient.name  != "Steve Mandanda")

croatia_only_final <- subset(team_name_france_croatia_final, team.name == "Croatia")
croatia_only_final1 <- subset(croatia_only_final, player.name  != "Lovre Kalinić")
croatia_only_final2 <- subset(croatia_only_final1, pass.recipient.name  != "Lovre Kalinić")


# construct dataset for connected passes only 
connected_pass_france_final <- subset(france_only_final2, is.na(pass.outcome.name))
connected_pass_croatia_final <- subset(croatia_only_final2, is.na(pass.outcome.name))
