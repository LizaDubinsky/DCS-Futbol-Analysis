...
belgium_png <- image_read("belgium_semi.png")
...
final_image_french_semi <- image_composite(image_scale(soccer_field, "x1000"), france_pgn1, offset = "+500+0")


#scaling Belgium network of passes image to 1000 height
belgium_png_1  <- image_scale(belgium_png_1 , "x1000")
#creating a composite of both images and moving the belgium network using offset to the right and down
# scaling the soccer field to 1000 in height 
final_image_belgian_semi <- image_composite(image_scale(soccer_field, "x1000"), belgium_png_1 , offset = "+0+0")
```
