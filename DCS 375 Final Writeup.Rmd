...
# player positions on team Belgium in the semifinal
...
btwn.france_semi <- betweenness(france_semi.g)
names(btwn.france_semi) <- V(france_semi.g)$name
ind <- order(-btwn.france_semi)
btwn.france_semi[ind][1:13]
``` 
...
```{r france-semi-closeness}
closeness.france_semi <- closeness(france_semi.g)
names(closeness.france_semi) <- V(france_semi.g)$name
ind <- order(-closeness.france_semi)
closeness.france_semi[ind][1:13]
```
...
btwn.belgium_semi <- betweenness(belgium_semi.g)
names(btwn.belgium_semi) <- V(belgium_semi.g)$name
ind <- order(-btwn.belgium_semi)
btwn.belgium_semi[ind][1:14]
``` 
...
```{r belgium_semi-closeness}
closeness.belgium_semi <- closeness(belgium_semi.g)
names(closeness.belgium_semi) <- V(belgium_semi.g)$name
ind <- order(-closeness.belgium_semi)
closeness.belgium_semi[ind][1:14]
```
...
btwn.france_final <- betweenness(france_final.g)
names(btwn.france_final) <- V(france_final.g)$name
ind <- order(-btwn.france_final)
btwn.france_final[ind][1:14]
``` 
...
```{r france-final-closeness}
closeness.france_final <- closeness(france_final.g)
names(closeness.france_final) <- V(france_final.g)$name
ind <- order(-closeness.france_final)
closeness.france_final[ind][1:14]
```
...
btwn.croatia_final <- betweenness(croatia_final.g)
names(btwn.croatia_final) <- V(croatia_final.g)$name
ind <- order(-btwn.croatia_final)
btwn.croatia_final[ind][1:13]
``` 
...
```{r croatia-final-closeness}
closeness.croatia_final <- closeness(croatia_final.g)
names(closeness.croatia_final) <- V(croatia_final.g)$name
ind <- order(-closeness.croatia_final)
closeness.croatia_final[ind][1:13]
```
