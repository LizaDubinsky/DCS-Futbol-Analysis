...
To create accessible network visualizations, we used shape and color to distinguish between the positions played by player in each team across both games. 
The below code is for the French team brought to the World Cup 2018 :
...
Below is the team brought by Croatia to the 2018 World Cup
...
Below is the team Belgium brought to the 2018 World Cup:
```{r belgium-players}
...
#### Assigning color and shape to network node's based on the position of the players
The color and shapes go as follows: 
- The goalkeeper has a yellow color and sphere shape node
- The defenders have a blue color and circle shape node
- The midfielders have purple color and square shape node
- The forwards have a green color and rectangle shape node
...
```{r france-final-received-passes-plot, warning = FALSE}
# plotting barplot of the frequency a player completed a pass, colored based on the positon of the player
...
```{r france-semi-received-passes-plot, warning = FALSE}
# plotting barplot of the frequency a player completed a pass, colored based on the positon of the player
...
```{r belgium-semi-sent-passes-plot, warning = FALSE}
# plotting barplot of the frequency a player completed a pass, colored based on the positon of the player
